...
#    2          Milestone 3 Completion All TODO items implemented,
#               including LED control, timing states, message switching,
#               LCD updates, and state-machine corrections.
#               Revision performed by Russell Buck.
#------------------------------------------------------------------
...
while repeat:
    try:
        ...
        # ? FIX: Clear LCD immediately on exit
