...
# ALWAYS show the current state, current temperature, and set temperature
# on the second line.
#
...
#    3          Updated LCD to always show state, Temp, and SetPoint
#    4          Updated LCD formatting to fit 16x2 display (T: and S:)
#------------------------------------------------------------------
...
class TemperatureMachine(StateMachine):
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            # Line 2: Fits 16 chars exactly ? "heat T:71F S:72"
            current_temp = floor(self.getFahrenheit())
            lcd_line_2 = f"{self.current_state.id} T:{current_temp}F S:{self.setPoint}"
